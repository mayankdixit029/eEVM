...
<br><br>
<form action="/seat/{{$seat->id}}/update" method="POST">
@csrf()
@method('put')
<h1 class="display-4" style="margin-left: 450px;"><b>Add Seats</b></h1>
  ...
  <input type="text"  name='name' value="{{$seat->name}}"class="form-control" placeholder="Enter Seat Name" aria-label="Username" aria-describedby="basic-addon1">
</div>
<br>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    ...
    <input type="text"  name='candidate_id' value="{{$seat->candidate_id}}"class="form-control" placeholder="Enter Candidate ID" aria-label="Username" aria-describedby="basic-addon1">
</div>
</div>
